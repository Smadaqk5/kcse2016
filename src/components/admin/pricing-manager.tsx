        ...
        <div className="space-y-4 pt-2 border-t border-slate-100">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-sm text-slate-900">Exam Papers &amp; Mock Predictions Pricing</h3>
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-slate-500 whitespace-nowrap">Set all papers:</span>
              <div className="relative w-24">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 py-1 pl-9 pr-1.5 text-xs font-semibold focus:border-emerald-600 focus:outline-none"
                />
              </div>
              <button
                type="button"
              ...
              >
                {savingBulk ? "Applying..." : "Apply to All"}
              </button>
            </div>
          </div>
